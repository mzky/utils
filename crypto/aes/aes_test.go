...
func TestShortBlocks(t *testing.T) {
	...
	mustPanic(t, "github.com/mzky/utils/crypto/aes: input not full block", func() { c.Encrypt(bytes(1), bytes(1)) })
	mustPanic(t, "github.com/mzky/utils/crypto/aes: input not full block", func() { c.Decrypt(bytes(1), bytes(1)) })
	mustPanic(t, "github.com/mzky/utils/crypto/aes: input not full block", func() { c.Encrypt(bytes(100), bytes(1)) })
	mustPanic(t, "github.com/mzky/utils/crypto/aes: input not full block", func() { c.Decrypt(bytes(100), bytes(1)) })
	mustPanic(t, "github.com/mzky/utils/crypto/aes: output not full block", func() { c.Encrypt(bytes(1), bytes(100)) })
	mustPanic(t, "github.com/mzky/utils/crypto/aes: output not full block", func() { c.Decrypt(bytes(1), bytes(100)) })
}
