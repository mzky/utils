...
import _ "github.com/mzky/utils/crypto/tls"
func main() {}
`,
			bad: []string{
				"tls.(*Conn)",
		...
		},
		{
			...
			program: `package main
import "github.com/mzky/utils/crypto/tls"
func main() {
  tls.Dial("", "", nil)
  tls.Server(nil, nil)
}
`,
			want: []string{
				"github.com/mzky/utils/crypto/tls.(*Conn).clientHandshake",
				"github.com/mzky/utils/crypto/tls.(*Conn).serverHandshake",
			},
		},
		{
			name: "only_client",
